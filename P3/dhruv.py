...
def main():
	...
	# valid_pred = regr.predict(X_valid)

	# print "Lin Reg Evaluation score:", eval(valid_pred, y_valid)
	...
	print "Gradient Boost Evaluation score:", eval(valid_pred, y_valid)
	...
	gb_test_pred = gb.predict(tmp_test)
	rfr_test_pred = rfr.predict(tmp_test)

	write_to_file("gb_preds.csv", gb_test_pred)
